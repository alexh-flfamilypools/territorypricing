// Legend.jsx — manager-editable color/price legend (now optional bottom-right card)
window.Legend = function Legend({ territories }) {
  // Auto-built from the unique colors in use, with the price ranges they cover.
  ...
  return (
    <div className="fp-legend">
      <div className="fp-legend-head"><span>Legend</span><span className="fp-legend-hint">auto-built from your areas</span></div>
      {entries.map(e => (
        <div key={e.color} className="fp-legend-row">
          <span className="fp-legend-sw" style={{ background: e.color }}></span>
